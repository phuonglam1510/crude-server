...
class CouponsController extends Controller
{
    ...
    public function addCoupons(Request $request)
    {
        ...
        if (!empty($data)) {
            $dataNeedInsert = [
                ...
                'reducedFee' => $data['couponsPrice'] ?? 0,
            ...
            $coupons = $this->couponsService->createCoupons($dataNeedInsert);
    ...
    public function getCoupons(Request $request)
    {
        ...
        if (
            ...
            $coupons = $this->couponsService->getAllCoupons(); 
        ...
        $this->success($coupons, null, 200);          
            ...
            $coupons = $this->couponsService->getCouponsByUserId($user->id);           
        }
        if (!empty($data['staff'])) {
        ...
        if ($data && $data['startAt']) {
            ...
            $end_at = $data['endAt'];
            $coupons = $this->couponsService->couponsRepo->getCouponsWithCondition(
                $userId,
                $start_at,
                $end_at
            );
    ...
    public function updateCoupons(Request $request)
    {
        ...
        $coupons = $this->couponsService->getCoupons($data['id']);
        if (!$coupons) {
       ...
       $couponsUpdate =  $this->couponsService->updateCoupons($dataNeedInsert);
        ...
        // }
        $this->success($couponsUpdate, null, 200);
    }
}
