...
class BatdongsanHouse extends Model
{
    use BaseModel, SoftDeletes;
    protected $table = 'batdongsan_houses';
    protected $fillable = [
        ...
        'internalDescription','type_news','commission', 'type_news_day', 'dinning_room', 'kitchen', 'terrace', 'car_parking', 'post', 'failed_quantity',
        'initialDescription','batdongsan_name' , 'batdongsan_password', 'update_status'
    ];
    ...
    public function Ownership(){
        return $this->belongsTo('App\Models\Dictionary\Ownership', 'ownership', 'id');
    }
